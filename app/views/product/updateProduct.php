...
if($_POST) {
    ...
    try {
        $update = ProductController::updateProduct($id, $name, $price);
    } catch (Exception $e) {
        $mr = $e->getMessage();
    }
}
...
<body>
    <header>
        <a class="btn r" href="productView.php">Atras</a>
    </header>
    ...
    <main>
        ...
        <form id="form" method="POST">
            ...
            <input name="name" type="text" placeholder="Nombre" value="<?php echo $product["name"]; ?>">

            <input name="price" type="number" placeholder="Precio" min="0" value="<?php echo $product["price"]; ?>">

            <button id="open-modal" class="btn g" type="button">Actualizar producto</button>
            
            <div class="container-modal">
                <div class="modal">
                    <h2 class="title">¿Estas seguro de que deceas actualizar el producto?</h2>
